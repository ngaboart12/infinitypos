        ...
        <div className='w-full relative '>
            ...
            <div className='px-[10px] z-10 relative w-full md:px-[50px] lg:px-[100px] py-6 flex flex-col lg:flex-row gap-[20px] items-center'>
                ...
                <div className='w-full lg:w-1/2 flex flex-col gap-[20px] items-center lg:items-start'>
                    <h1 className='text-[32px] text-white font-[700] max-w-[500px] leading-[50px] text-center lg:text-start'>Upgrade Your Business with Our Cutting - Edge POS Solution</h1>
                    <span className='text-[14px] text-[#FAFAFA] text-center lg:text-start'>Our POS system software is designed to cater to various industries, including bars, restaurants, coffee shops, pizzerias, alimentation, salons, and more.</span>
